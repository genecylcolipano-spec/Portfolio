...
const CommentForm = memo(({ onSubmit, isSubmitting }) => {
    ...
    const handleImageChange = useCallback((e) => {
        ...
        if (file.size > MAX_IMAGE_BYTES) {
            setFileError('File size must be less than 5MB. Please choose a smaller image.');
            e.target.value = '';
            return;
        }
    ...
    }, [newComment, userName, imageFile, onSubmit, clearImage]);

    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1000">
                <label htmlFor="comment-name" className="block text-sm font-medium text-white">
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1200">
                <label htmlFor="comment-message" className="block text-sm font-medium text-white">
...
const Komentar = () => {
    ...
    // Regular (unpinned) comments, kept in sync via Realtime
    useEffect(() => {
